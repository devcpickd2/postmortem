                   ...
                   <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <select class="form-control <?= form_error('tipe_user') ? 'invalid' : '' ?>" name="tipe_user">
                            ...
                            <option value="3" <?= set_select('tipe_user', '3'); ?> <?= $pegawai->tipe_user == 3?'selected':'';?>>Foreman Produksi</option>
                            <option value="8" <?= set_select('tipe_user', '8'); ?> <?= $pegawai->tipe_user == 8?'selected':'';?>>Foreman QC</option>
